...
output: 
  flexdashboard::flex_dashboard:
    navbar:
      - { title: "Data: 31/12/2020",icon: ion-ios-calendar-outline, href: "http://www.tesouro.fazenda.gov.br/-/relatorios-garantias-e-contratacoes-diretas" ,align: right }
    orientation: columns
...
output$Contratos <- renderDT(server = FALSE, {
  ...
  datatable(filtro_tipo_contratos_assinados[,c(29,1,28,31,27,5,30,9,10,22,23)], 
    ...
    "}"),
     ...
     colnames = c('ANO','CONTRATO' ,'DATA ASSINATURA', 'GRUPO', 'MUTUARIO','UF' ,'STATUS', 'TIPO', 'CREDOR', 'MOEDA', 'VALOR CONTRATADO')
