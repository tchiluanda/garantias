...
output: 
  flexdashboard::flex_dashboard:
    navbar:
      - { title: "Data: 31/12/2019",icon: ion-ios-calendar-outline, href: "https://www.tesourotransparente.gov.br/" ,align: right }
    orientation: columns
...
fluidPage(
 fluidRow(
  ...
  column(width=3,align="right",div(style = "height:17px;font-size: 13pt;background-color: ;",textOutput("Garantia_interna_geral"))),
      ...
      br(),
 column(width=1,align="left",div(style = "height:17px;font-size: 12pt;background-color: ;","")),
 
  column(width=5,align="center",div(style = "height:17px;color: #737373;background-color: ;","Internas Cambiais:")),
  ...
  column(width=4,align="right",div(style = "height:17px;color: #737373;background-color: ;","Internas Demais:")),
  column(width=1,align="right",div(style = "height:17px;font-size: 12pt;background-color: ;","")),
 ...
 br(), 
  ...
  column(width=3,align="left",div(style = "height:17px;background-color: ;","Até 12 meses")),
...
data_atm_interna <- c(Estados_valor_atm_interna, Bancos_Federais_valor_atm_interna, Municipios_valor_atm_interna, Estatais_Federais_valor_atm_interna, Entidades_Controladas_valor_atm_interna)



output$barras_total_atm_interna <- renderPlotly({
 
  plot_ly(y =~ reorder(y_atm, data_atm_interna), type = 'bar', 
                 orientation = 'h',  
  ...
  layout(height = 200, 
    ...
    add_annotations(xref = 'x1', yref = 'y',
                  x = data_atm_interna * 0.9 + 0.1,  y = y_atm,
...
data_custo_interna <- c(Estados_valor_custo_interna, Bancos_Federais_valor_custo_interna, Municipios_valor_custo_interna, Estatais_Federais_valor_custo_interna, Entidades_Controladas_valor_custo_interna)



output$barras_total_custo_interna <- renderPlotly({
 
  plot_ly(y =~ reorder(y_custo, data_custo_interna), type = 'bar', 
                 orientation = 'h',  
  ...
  layout(height = 200, 
    ...
    add_annotations(xref = 'x1', yref = 'y',
                  x = data_custo_interna * 0.9 + 0.1,  y = y_custo,
...
output$divida_total_estados <-renderPlotly(
  ...
  hoverinfo = "text"
      ...
      layout(showlegend=TRUE, width = 880, height = 650 ,
...
output$ATM <-renderPlotly(
  ...
  add_trace(y = ~sum((agrupador_ATM_estados_formatado$ATM_Total*agrupador_formatado_estados$total_total))/sum(agrupador_formatado_estados$total_total),
      ...
      layout(showlegend=TRUE, width = 870, height = 650 ,
              legend = list(orientation = 'h', x = 0.9, y = 1,
                           xanchor = 'center', yref = 'paper',
                           font = list(size = 14),
                           bgcolor = 'transparent'),
...
output$cambial_estados <-renderPlotly(
  ...
  hoverinfo = "text"
      ...
      layout(autosize = F  ,width = 870, height = 650 ,legend = list(orientation = 'h', x = 0.8, y = 1.2,
                           xanchor = 'center', yref = 'paper',
                           font = list(size = 14),
                           bgcolor = 'transparent'),
              title = "",
...
> Fonte: .
  <br>Dívida Cambial é a soma entre a dívida interna cambinal mais a dívida externa. O peso da dívida cambinal na carteira é calculado pela divisão entre a parcela cambial e a total.
...
output$divida_total_municipios <-renderPlotly(
  ...
  hoverinfo = "text"
      ...
      layout(showlegend=TRUE, width = 950, height = 650 ,
              legend = list(orientation = 'h', x = 0.9, y = 1,
                           xanchor = 'center', yref = 'paper',
                           font = list(size = 14),
                           bgcolor = 'transparent'),
...
output$cambial_municipios <-renderPlotly(
  ...
  hoverinfo = "text"
    ...
    hide_colorbar() %>%
      ...
      layout(autosize = F  ,width = 900, height = 650 ,legend = list(orientation = 'h', x = 0.8, y = 1.2,
                           xanchor = 'center', yref = 'paper',
                           font = list(size = 14),
                           bgcolor = 'transparent'),
              title = "",
...
output$cambial_bancos_federais <-renderPlotly(
  ...
  hoverinfo = "text"
      ...
      layout(width = 870, height = 630 ,legend = list(orientation = 'h', x = 0.8, y = 1.2,
                           xanchor = 'center', yref = 'paper',
                           font = list(size = 14),
                           bgcolor = 'transparent'),
              title = "",
...
output$Contratos <- renderDT({
  ...
  datatable(filtro_tipo_contratos_assinados[,c(28,1,17,30,26,29,9,10,22,23)], 
          rownames = FALSE,
    ...
    "}"),
     ...
     colnames = c('ANO','CONTRATO' ,'DATA ASSINATURA', 'GRUPO', 'MUTUARIO', 'STATUS', 'TIPO', 'CREDOR', 'MOEDA', 'VALOR CONTRATADO')
