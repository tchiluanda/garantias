...
output: 
  flexdashboard::flex_dashboard:
    navbar:
      - { title: "Data: 30/04/2022",icon: ion-ios-calendar-outline, href: "https://www.tesourotransparente.gov.br/publicacoes/relatorio-quadrimestral-de-operacoes-de-credito-garantidas-rqg/" ,align: right }
    orientation: columns
...
#section-quadro-geral .card {
  font-size: 12px;
}

#section-quadro-geral .card .col-sm-3,
#section-quadro-geral .card .col-sm-5,
#section-quadro-geral .card .col-sm-6 {
  padding-right: 0;
  padding-left: 0;
}
...
formata_numero <- function(x){
  as.numeric(format(round(x,2), big.mark = ".", decimal.mark = ","))
}
...
#prepara agrupador atm completo
agrupador_atm_completo <- agrupador_atm_completo %>%
  #mutate(across(starts_with("ATM"), numero))
  mutate_at(.vars = vars(starts_with("ATM")), .funs = numero)
...
agrupador_custo_completo <- agrupador_custo_completo %>%
                   mutate_at(
                   vars(starts_with("Custo_")), 
...
agrupador_percentual_vincendo <- agrupador_percentual_vincendo %>%
  mutate_at(
    vars(ends_with("_percentual")), 
    .funs = ~scales::percent_format(accuracy = .01, decimal.mark = ",", big.mark = ".")(as.numeric(str_replace(str_sub(., 1, -2), ",", "."))/100))
...
fluidPage(
 fluidRow(
  ...
  column(width=6,align="center",div(style = "height:17px;font-size: 12px;background-color: ;","")),
  
   column(width=3,align="right",div(style = "height:17px;font-size: 12px;background-color: ;","R$ Mi")),
   br(),
  column(width=6,align="left",div(style = "height:17px;font-size: 13px;font-weight: bold;background-color: ;","OPERAÇÕES GARANTIDAS")),
  
  
  column(width=3,align="right",div(style = "height:17px;font-size: 13px;font-weight: bold;background-color: ;",textOutput("Garantia_Total_geral"))),
  
       br(), 
  
  column(width=6,align="left",div(style = "height:17px;font-size: 13px;background-color: ;","INTERNAS")),
  
  column(width=3,align="right",div(style = "height:17px;font-size: 13px;background-color: ;",textOutput("Garantia_interna_geral"))),
  
  
      br(),
 
 
  column(width=6,align="left",div(style = "height:17px;color: #737373;background-color: ;","Internas Cambiais", class = "space-left")),
  
  column(width=3,align="right",div(style = "height:17px;color: #737373;font-size: 13px;background-color: ;",textOutput("Garantia_interna_cambial_geral"))),
  
     
   br(),
  
 
  column(width=6,align="left",div(style = "height:17px;color: #737373;background-color: ;","Internas Demais", class = "space-left")),
  #column(width=1,align="right",div(style = "height:17px;font-size: 12px;background-color: ;","")),
 
  column(width=3,align="right",div(style = "height:17px;color: #737373;font-size: 13px;background-color: ;",textOutput("Garantia_interna_demais_geral"))),
  
 br(), 
  column(width=6,align="left",div(style = "height:17px;font-size: 13px;background-color: ;","EXTERNAS")),
  
  column(width=3,align="right",div(style = "height:17px;font-size: 13px;background-color: ;",textOutput("Garantia_externa_geral"))),
  
      br(), br(),
  column(width=5,align="left",div(style = "height:17px;font-size: 13px;font-weight: bold;background-color: ;","VIDA MÉDIA - ATM")),
  column(width=4,align="right",div(style = "height:17px;font-size: 13px;font-weight: bold;background-color: ;",textOutput("Garantia_ATM_geral"))),
      br(),br(),
  column(width=5,align="left",div(style = "height:17px;font-size: 13px;font-weight: bold;background-color: ;","CUSTO MÉDIO")),
  column(width=4,align="right",div(style = "height:17px;font-size: 13px;font-weight: bold;background-color: ;",textOutput("Garantia_custo_geral"))),
      br(),br(),
  column(width=6,align="left",div(style = "height:17px;font-size: 13px;font-weight: bold;background-color: ;","PERCENTUAL VINCENDO")),
  column(width=2,align="center",div(style = "height:17px;font-size: 12px;background-color: ;","")),
      
  column(width=4,align="right",div(style = "height:17px;font-size: 12px;background-color: ;","R$ Milhões")),
  br(),
...
observeEvent(Garantia_ATM_reativo_geral(),{
  ...
  output$Garantia_ATM_geral <- renderText(
    paste0(format(round(filtro_classificador_geral_atm$ATM_Total,2), big.mark = ".", decimal.mark = ","), " anos")
    )
...
output$Contratos <- renderDT(server = FALSE, {
  ...
  datatable(filtro_tipo_contratos_assinados[,c(18,1,3,34,29,5,33,9,10,24,25)], 
